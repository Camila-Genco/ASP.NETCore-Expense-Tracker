        ...
        public async Task<IActionResult> Index()
        {
            ...
            if (userIdClaim != null && int.TryParse(userIdClaim.Value, out int userId))
            {
                ...
                List<Transaction> SelectedTransactions = await _context.Transactions
                   ...
                   .Where(y => y.UserId == userId && y.Date.Date >= StartDate && y.Date.Date <= EndDate)
                   .ToListAsync();
               ...
               .Where(t => t.UserId == userId && t.Date.Date >= StartWeekDate && t.Date.Date <= EndWeekDate && t.Category.Type == "Expense")
               ...
               .ToListAsync();
                ...
                .Where(t => t.UserId == userId && t.Date.Date >= StartWeekDate && t.Date.Date <= EndWeekDate && t.Category.Type == "Income")
                .GroupBy(t => t.Date.Date)
